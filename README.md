...
## 测试说明
测试使用<font color =green>test.bat</font>进行测试，脚本放置在../test/路径下
...
## 七、对于AI做的设计的感觉
- 整体上讲，ai做的东西的逻辑是正确的，但是在细节方面很多地方欠缺考虑，比如在对纯值的参数的处理上很粗糙，需要我去补充修改它的代码，以及对一些错误的参数没有进行判断，也需要我去进行修改，总体来讲，只要写好prompt，ai是能做好大框架的东西的，但是一些具体的要求上的细节还需要我们去读懂ai写的代码后进行校正
- 在写<font color = red>test.bat脚本</font>时，测试5出现了问题，脚本没办法正确识别“2025 5”这个参数，错误的传入了“2025”，让ai进行检查时它在反复跟我绕圈子，最后是上网搜索后进行的修改，ai在这种细节上的把控可见一斑（）。
- ai还是推荐gemini+豆包的组合（）。